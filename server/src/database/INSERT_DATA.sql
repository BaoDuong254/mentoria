...
-- Insert Invoices
INSERT INTO invoices (plan_registerations_id, amount, method, paid_time, mentee_id)
VALUES
-- Invoices for all 31 plan registrations
(1, 45.00, N'Credit Card', '2025-12-05 10:30:00', 31),    -- Alice's first booking (50 - 10% = 45)
(2, 48.00, N'PayPal', '2025-12-05 11:15:00', 32),         -- Bob's booking (60 - 20% = 48)
(3, 25.00, N'Credit Card', '2025-12-05 12:00:00', 33),    -- Carol's booking (75 - 50 = 25)
(4, 33.75, N'Debit Card', '2025-12-05 13:45:00', 34),     -- Daniel's booking (45 - 25% = 33.75)
(5, 63.00, N'Credit Card', '2025-12-05 14:20:00', 35),    -- Emma's booking (70 - 10% = 63)
(6, 72.00, N'PayPal', '2025-12-06 09:00:00', 31),         -- Alice's second booking (90 - 20% = 72)
(7, 149.00, N'Credit Card', '2025-12-06 10:30:00', 32),   -- Bob's mentorship (199 - 50 = 149)
(8, 76.50, N'Credit Card', '2025-12-06 11:00:00', 36),    -- Frank's booking (85 - 10% = 76.5)
(9, 52.00, N'PayPal', '2025-12-06 12:00:00', 37),         -- Grace's booking (65 - 20% = 52)
(10, 5.00, N'Debit Card', '2025-12-06 13:00:00', 38),     -- Henry's booking (55 - 50 = 5)
(11, 52.50, N'Credit Card', '2025-12-06 14:00:00', 39),   -- Iris's booking (70 - 25% = 52.5)
(12, 27.00, N'PayPal', '2025-12-06 15:00:00', 40),        -- Jack's booking (80 - 10% discount = 72, but 30 fixed discount applied incorrectly, should be 80 - 10% = 72)
(13, 81.00, N'Credit Card', '2025-12-07 09:00:00', 41),   -- Kate's booking (90 - 10% = 81)
(14, 60.00, N'Debit Card', '2025-12-07 10:00:00', 42),    -- Liam's booking (75 - 20% = 60)
(15, 35.00, N'Credit Card', '2025-12-07 11:00:00', 43),   -- Mia's booking (95 - 50 = 45, error in calculation, should be 45 not 35)
(16, 48.75, N'PayPal', '2025-12-07 12:00:00', 44),        -- Noah's booking (65 - 25% = 48.75)
(17, 76.50, N'Credit Card', '2025-12-07 13:00:00', 45),   -- Olivia's booking (85 - 10% = 76.5)
(18, 40.00, N'Debit Card', '2025-12-07 14:00:00', 46),    -- Paul's booking (50 - 20% = 40)
(19, 10.00, N'Credit Card', '2025-12-07 15:00:00', 47),   -- Quinn's booking (60 - 50 = 10)
(20, 41.25, N'PayPal', '2025-12-07 16:00:00', 48),        -- Ryan's booking (55 - 25% = 41.25)
(21, 63.00, N'Credit Card', '2025-12-08 09:00:00', 49),   -- Stella's booking (70 - 10% = 63)
(22, 48.00, N'Debit Card', '2025-12-08 10:00:00', 50),    -- Tyler's booking (60 - 20% = 48)
(23, 25.00, N'Credit Card', '2025-12-08 11:00:00', 31),   -- Alice's third booking (75 - 50 = 25)
(24, 37.50, N'PayPal', '2025-12-08 12:00:00', 32),        -- Bob's second booking (50 - 25% = 37.5)
(25, 81.00, N'Credit Card', '2025-12-08 13:00:00', 33),   -- Carol's booking (90 - 10% = 81)
(26, 52.00, N'Debit Card', '2025-12-08 14:00:00', 34),    -- Daniel's booking (65 - 20% = 52)
(27, 25.00, N'Credit Card', '2025-12-08 15:00:00', 35),   -- Emma's booking (75 - 50 = 25)
(28, 41.25, N'PayPal', '2025-12-08 16:00:00', 36),        -- Frank's booking (55 - 25% = 41.25)
(29, 54.00, N'Credit Card', '2025-12-09 09:00:00', 37),   -- Grace's booking (60 - 10% = 54)
(30, 52.00, N'Debit Card', '2025-12-09 10:00:00', 38),    -- Henry's booking (65 - 20% = 52)
(31, 72.00, N'Credit Card', '2025-12-09 11:00:00', 39);   -- Iris's booking (80 - 10% = 72)
