    ...
    <div className={styles.dashboardContainer}>
      {mentors.map((mentor) => (
        <div key={mentor.id} className={styles.mentorCard}>
            ...
            <div className={styles.bottomSection}>
              <div className={styles.scheduleInfo}>
                <div className={styles.scheduleItem}>
                  <span className={styles.scheduleIcon} role='img' aria-label='calendar'>
                    📅
                  </span>
                  <span>{mentor.scheduledDate}</span>
                </div>
                <div className={styles.scheduleItem}>
                  <span className={styles.scheduleIcon} role='img' aria-label='time'>
                    🕑
                  </span>
                  <span>{mentor.scheduledTime}</span>
                </div>
              </div>
          ...
          <div className={`${styles.statusBadge} ${mentor.isConfirmed ? styles.confirmed : styles.pending}`}>
            {mentor.isConfirmed ? "Confirmed" : "Pending"}
          </div>
        </div>
      ))}
    </div>
